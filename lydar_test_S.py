...
class TurtleBotController:
    def __init__(self):
        ...
        self.max_dist_to_obstacle = 0.18 # Seuil de distance pour la détection des obstacles
        self.min_dist_to_obstacle = 0.15
    ...
    def lidar_callback(self, data):
        ...
        if min_distance < self.max_dist_to_obstacle:
            obstacle_detected = True
        else :
            obstacle_detected = False
        
        if min_distance < self.min_dist_to_obstacle:
            obstacle_closed = True
        else :
        ...
        if obstacle_detected:
            ...
            #Déplacements
            if obstacle_closed:
                if (self.obstacle_detected_ahead) :
                    #tourne à droite
